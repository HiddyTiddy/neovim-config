...
local mappings = {
    ...
    d = {
        name = "Vimspector",
        j = "<Plug>VimspectorStepOver<cr>",
        l = "<Plug>VimspectorStepInto<cr>",
        k = "<Plug>VimspectorStepOut<cr>",
        b = "<Plug>VimspectorToggleBreakpoint<cr>",
        r = "<Plug>VimspectorRunToCursor<cr>",
    },
}
